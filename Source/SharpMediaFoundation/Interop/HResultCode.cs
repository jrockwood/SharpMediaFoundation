// ---------------------------------------------------------------------------------------------------------------------
// <copyright file="HResultCode.cs" company="Justin Rockwood">
...
namespace SharpMediaFoundation.Interop
{
    ...
    public enum HResultCode
    {
        ...
        MF_S_MULTIPLE_BEGIN = unchecked(0x000D36D8),
        ...
        MF_S_ACTIVATE_REPLACED = unchecked(0x000D36FD),
        ...
        MF_S_ASF_PARSEINPROGRESS = unchecked(0x400D3A98),
        ...
        MF_I_MANUAL_PROXY = unchecked(0x400D4272),
        ...
        MF_S_SINK_NOT_FINALIZED = unchecked(0x000D4A42),
        ...
        MF_S_SEQUENCER_CONTEXT_CANCELED = unchecked(0x000D61AD),
        MF_E_NO_SOURCE_IN_CACHE = unchecked((int)0xC00D61AE),
        MF_S_SEQUENCER_SEGMENT_AT_END_OF_STREAM = unchecked(0x000D61AF),
        ...
        MF_S_TRANSFORM_DO_NOT_PROPAGATE_EVENT = unchecked(0x000D6D75),
        ...
        MF_S_PROTECTION_NOT_REQUIRED = unchecked(0x000D7150),
        ...
        MF_S_WAIT_FOR_POLICY_SET = unchecked(0x000D7168),
        MF_S_VIDEO_DISABLED_WITH_UNKNOWN_SOFTWARE_OUTPUT = unchecked(0x000D7169),
        ...
        MF_S_PE_TRUSTED = unchecked(0x000D7173),
        ...
        MF_S_CLOCK_STOPPED = unchecked(0x000D9C44),
