// ---------------------------------------------------------------------------------------------------------------------
// <copyright file="IMFAttributes.cs" company="Justin Rockwood">
...
namespace SharpMediaFoundation.Interop
{
    ...
    [ComImport, SuppressUnmanagedCodeSecurity, HeaderFile("mfobjects.h")]
    ...
    public interface IMFAttributes
    {
        ...
        HResult GetItem(
            ...
            [In, Out,
             MarshalAs(
                 ...
                 MarshalCookie = "IMFAttributes.GetItem",
                 MarshalTypeRef = typeof(PropVariantMarshaler))]
            PropVariant pValue);
        ...
        /// <summary>Use <see cref="GetBlob"/> instead of this.</summary>
        [PreserveSig]
        ...
        HResult GetItemByIndex(
            ...
            [In, Out,
             MarshalAs(
                 UnmanagedType.CustomMarshaler,
                 MarshalCookie = "IMFAttributes.GetItemByIndex",
                 MarshalTypeRef = typeof(PropVariantMarshaler))]
            PropVariant pValue);
